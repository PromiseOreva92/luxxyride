            ...
            <div class="row">
                <div class="col-sm-2" id="nav">
                    <ul class="nav nav-pills nav-stacked" id="menu">
                        ...
                        <li class="active"><a href="profile.php" style="font-weight:bold;font-family:sans-serif"><span class="fa fa-user-circle"></span> Profile</a></li>
                        <li><a href="vehicles.php" style="font-weight:bold;font-family:sans-serif"><span class="fa fa-car"></span> Add Vehicle</a></li>
...
<!--                    <div class="row" style="">
                        <div class="col-sm-8" style="font-size:16px;font-weight:bold">
                            FULL NAME:
                        </div>                       
                    </div>
